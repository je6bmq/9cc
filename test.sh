...
try 3 'main(){if(3 < 3) return 1; else return 3;}'
...
try 10 'foo(k) {if(k<10) {return 10;} else {return 1;}} main() {return foo(1);}'
try 1 'foo(k) {if(k<10) {return 10;} else {return 1;}} main() {return foo(10);}'
try 16 'foo(x,y,z) {return x+y+z;} main(){hoge = 0; a=3; b=5; hoge=foo(a,b, foo(a,b,0)); return hoge;}'
